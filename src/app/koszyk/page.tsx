    ...
    <section className="flex mt-16 z-20 lg:mt-28 lg:min-h-0 w-full px-5 flex-col gap-4 lg:gap-12 lg:justify-between">
      ...
      <div>
        <div className="flex flex-col md:flex-row gap-4 w-full h-full">
          <div className="w-full group border border-lightgray rounded-md flex flex-col p-4 gap-4 relative overflow-hidden h-full shadow-lg">
            <h3 className="text-2xl font-semibold tracking-wider">
              Produkty w koszyku
            </h3>
            <ProductsList />
          </div>
          <div className="group border border-lightgray rounded-md flex flex-col p-4 gap-4 relative overflow-hidden shadow-lg w-full h-full">
            <h3 className="text-2xl font-semibold tracking-wider">
              Podsumowanie
            </h3>
            <ShoppingBagSummary />
