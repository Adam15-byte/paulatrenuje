...
const Contents: FC<ContentsProps> = ({ ebookData }) => {
  ...
  return (
    <section className="flex flex-col px-4 max-w-4xl self-center gap-8 mt-16 w-full">
      <div className="flex justify-between w-full items-center gap-6 md:gap-10">
        <div
          onClick={handlePreviousPage}
          className="p-2 group border-2 border-orange text-orange hover:text-white hover:bg-orange rounded-full flex items-center justify-center cursor-pointer transition-all"
        >
          <ChevronLeft
            size={24}
            strokeWidth={2.5}
        ...
        <div className="flex flex-col gap-4 items-center">
          ...
          <p className="text-base md:text-lg font-semibold bg-gray px-2 py-1 rounded-md text-white">
            Strona {page}/{maxPage}
          </p>
        </div>
        <div
          onClick={handleNextPage}
          className="p-2 group border-2 border-orange text-orange hover:text-white hover:bg-orange rounded-full items-center justify-center cursor-pointer transition-all"
        >
              ...
              <div key={item.label} className="flex flex-col gap-4 px-4">
                <div className="flex gap-4 items-center">
                  <motion.div
                    ...
                    className="flex items-center w-7 h-7 text-4xl font-bold justify-center text-white bg-pink rounded-full overflow-hidden shadow-xl"
                  >
                    {index + 1}
                  </motion.div>
                  <motion.p
                    ...
                    className="font-normal md:font-medium text-base md:text-lg uppercase"
                  >
                    {item.label}
                  </motion.p>
                </div>
